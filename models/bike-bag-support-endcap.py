...
support_width, support_height, support_depth = 100, 22, 10
fillet_radius = 10

bag_support_radius = 11.4/2
...
with BuildPart() as whole:
    ...
    with BuildSketch():
        with Locations((-bag_support_spacing/2, 0), (bag_support_spacing/2, 0)):
...
exporter3d.write("bike-bag-support-endcap.3mf")
